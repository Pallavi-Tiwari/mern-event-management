...
export default function UpdateEventListing() {
    ...
    return (
        <main className='p-3 max-w-4xl mx-auto'>
            <h1 className='text-3xl font-semibold text-center my-7'>Update an Event Listing</h1>
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                <div className='flex flex-col gap-4 flex-1'>
                    ...
                    <div className='flex flex-wrap gap-6'>
                        ...
                        <div className='flex items-center gap-4'>
                            <input type='number' id='seat' min='1' max='2000' required onChange={handleChange} value={formData.seats} />
                            <p>Seats</p>
                        </div>
                        <div className='flex items-center gap-4'>
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    <button disabled={loadingEffect||uploading} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>{loadingEffect ? 'Updating Event Listing...' : 'Update Event Listing'}</button>
